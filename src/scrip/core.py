...
def _parse_begin_file_line(line: str) -> tuple[str | None, bool]:
...
def _parse_empty_dir_line(line: str) -> str | None:
...
def _parse_end_file_line(line: str) -> tuple[str | None, bool]:
